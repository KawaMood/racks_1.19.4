#> pk_racks:base/uninstall/in_custom_dimension/start
...
tp @s @e[type=marker,tag=pk.dimension.marker,predicate=pk_racks:scores/dimension_marker/matching_id,limit=1]

# Wait 1 tick before relocating to the right position
schedule function pk_racks:base/uninstall/in_custom_dimension/after_1t 1t