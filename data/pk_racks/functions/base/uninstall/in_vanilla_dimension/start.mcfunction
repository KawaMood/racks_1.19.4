#> pk_racks:base/uninstall/in_vanilla_dimension/start
...
execute if score $temp pk.dimension.id matches -1 in minecraft:the_nether positioned as @s run function pk_racks:base/uninstall/in_vanilla_dimension/forceload
execute if score $temp pk.dimension.id matches 0 in minecraft:overworld positioned as @s run function pk_racks:base/uninstall/in_vanilla_dimension/forceload
execute if score $temp pk.dimension.id matches 1 in minecraft:the_end positioned as @s run function pk_racks:base/uninstall/in_vanilla_dimension/forceload